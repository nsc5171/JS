```
#eval("  ");
-> takes in a string and compiles and executes it as if JS statements;
...
#Block scope
-> JS doesn't support it variables when variables are declared with var, but let and const do support. ------??
...
#module pattern:
-> it's basically wrapping up all functionality and code in a private function and exposing only the required route for the functionality to be executed
